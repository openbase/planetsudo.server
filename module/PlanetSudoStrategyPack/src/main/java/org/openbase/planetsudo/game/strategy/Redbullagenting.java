 ...
 */
public class Redbullagenting extends AbstractStrategy {

    public Redbullagenting() {
    }

    public Redbullagenting(AgentInterface a) {
        super(a);
    }
    ...
    protected void loadRules() {
        ...
        //-------------------------------------------->
        createRule(new Rule("DREH UM", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("Sammel", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("gehzummutterschiff", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("gibResource", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("mines", ALL) {
            @Override
            protected boolean constraint() {
                return agent.getFuelInPercent() < 4;
...
//-------------------------------------------->
        createRule(new Rule("GesichterVerteilen", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("DEINEMUTTERWIRDSTERBEN", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("markersindgeilo", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("whatthefuck", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("DEINEMUTTERWIRDSTERBENmitdenanderen", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("Hilfmir", ALL) {
            @Override
            protected boolean constraint() {
...
//-------------------------------------------->
        createRule(new Rule("Hilfmir", ALL) {
            ...
            protected void action() {
                ...
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
                agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();agent.goToMothership();
...
//-------------------------------------------->
        createRule(new Rule("tankentanken", ALL) {
            @Override
            protected boolean constraint() {
