 ...
 */
public class KimKardashian extends AbstractStrategy {

    public KimKardashian() {
    }

    public KimKardashian(AgentInterface a) {
        super(a);
    }
    ...
    protected void loadRules() {
        ...
        createRule(new Rule("Zerstöre Gegner Muterschiff", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Zur Resource fahren", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Resource aufnehmen", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Resource zum Mutterschiff bringen", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("Feind Killen", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Resource ablegen", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("Helfen", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("Hilfe ersuchen", ALL) {
            @Override
            protected boolean constraint() {
