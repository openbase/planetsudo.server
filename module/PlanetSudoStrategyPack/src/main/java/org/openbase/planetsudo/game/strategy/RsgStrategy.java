 ...
 */
public class RsgStrategy extends AbstractStrategy {

    public RsgStrategy() {
    }

    public RsgStrategy(AgentInterface a) {
        super(a);
    }
    ...
    protected void loadRules() {
        ...
        createRule(new Rule("finde Resouce", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("nehme Resource", ALL) {
            @Override
            protected boolean constraint() {
                return !agent.isCarringResource() && agent.isTouchingResource();
            }
        ...
        createRule(new Rule("bringe Resource zum Mothership", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("lade ab", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("tanken", ALL) {
            ...
            @Override
            protected void action() {
                agent.orderFuel(100 - agent.getFuelInPercent());
            }
        });

        createRule(new Rule("vermeide Kollision", ALL) {
            @Override
            protected boolean constraint() {
