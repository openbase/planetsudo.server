...
public class Attack extends AbstractStrategy {
    ...
    public Attack(AgentInterface a) {
        super(a);
    }
    ...
    protected void loadRules() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Kampf gegen die GEGNER", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Sehe Resource", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Sammle Resource", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Zurück zu Schiff", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Abgabe", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Tanken check", ALL) {
            @Override
            protected boolean constraint() {
        ...
        createRule(new Rule("Tanken", ALL) {
            @Override
            protected boolean constraint() {
                return agent.isAtMothership() && agent.getFuelInPercent() <30 && mothership.hasFuel();
            }
        ...
        //-------------------------------------------->
        createRule(new Rule("Der SIEG", DELTA) {
            @Override
            protected boolean constraint() {
                return agent.seeAdversaryMothership();
            }
        ...
        //-------------------------------------------->
        createRule(new Rule("MeinKampf", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("MeinGegenKampf", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Rettung meine KAMERADEN", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Rückzuhg", ALL) {
            @Override
            protected boolean constraint() {
        ...
        //-------------------------------------------->
        createRule(new Rule("Verhindere Kolison", ALL) {
            @Override
            protected boolean constraint() {
